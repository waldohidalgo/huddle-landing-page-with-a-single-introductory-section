...
<template>
  <main class="py-[30px] px-[35px] lg:p-[53px_67px] relative">
    <div
      class="absolute top-0 right-0 left-0 bottom-0 z-[-1] bg-violet lg:hidden overflow-hidden"
    >
      <svg width="375" height="373" xmlns="http://www.w3.org/2000/svg">
        ...
        <g fill="none" fill-rule="evenodd">
          ...
          <path
            ...
            d="M0 318.687L375 102v119.176L0 360.228z"
          />
          <rect
            fill="url(#c)"
            opacity=".558"
    ...
    <div
      class="absolute top-0 right-0 left-0 bottom-0 z-[-1] bg-violet hidden lg:block overflow-hidden"
    >
    ...
    <div>
      <div>
        <svg
          ...
          class="w-[163px] aspect-[264/49] md:w-[281px]"
          viewBox="0 0 264 49"
        >
          <g fill="#fff">
            <path
      ...
      <div class="mt-[58px] lg:mt-[87px] flex flex-col lg:flex-row lg:gap-[4%]">
        <img
          class="lg:max-w-[56%]"
        ...
        <div>
          <h1
            class="text-center text-[22.5px] font-poppins font-bold mt-[57px] text-white md:text-start md:text-[39px] md:mt-[48px]"
          >
            Build The Community Your Fans Will Love
          </h1>
          <p
            class="text-center font-openSans mt-[12px] text-[15px] text-white md:text-start md:mt-[20px] md:text-[18px]"
          >
          ...
          <button
            class="font-openSans block bg-white text-violet mt-[26px] py-[10px] mx-auto w-[66%] rounded-[9%/50%] text-[12px] md:me-auto md:ms-0 md:mt-[27px] sm:w-[39%] md:py-[12px] lg:rounded-[13%/50%] lg:text-[20px] hover:bg-softMagenta hover:text-white shadow-[0px_8px_15px_rgba(0,0,0,0.5)]"
          >
            Register
          </button>
        </div>
